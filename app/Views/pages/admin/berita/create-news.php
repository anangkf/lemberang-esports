...
<?= $this->section('content'); ?>
  ...
  <div class="container">
    <form action="<?= base_url('admin/berita') ?>" method="post" enctype="multipart/form-data" class="col-12">
      <?= csrf_field() ?>
      ...
      <div class="form-group">
          ...
          <textarea type="text" class="form-control" id="content" name="content" placeholder="Tulis konten berita"></textarea>
      </div>
